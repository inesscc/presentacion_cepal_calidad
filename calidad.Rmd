...
## Subdepartamento de Marcos y Muestras
...
- Criterio de Acuracidad, Confiabilidad o Precisión
...
.center[
$\sigma^2( \hat{\theta}) : \text{Varianza de la estimación}$
...
.center[
<img src="imagenes/flecha.png" width="800" />
...
- **Proporción y razones entre 0 y 1**, el cálculo de los 𝑑𝑓 y 𝑡𝑚 se realiza  sobre las unidades de análisis en la subpoblación que participan en el “Denominador”.
